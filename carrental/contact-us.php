...
if($lastInsertId)
{
$msg="Consulta enviada. Lo contactaremos a la brevedad";
}
else 
{
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>Póngase en contacto utilizando el siguiente formulario</h3>
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Número de teléfono <span>*</span></label>
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:34-26-88-04"><?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
            <li>
