...
<li>
    <h4 style="color:red">Reserva No #<?php echo htmlentities($result->BookingNumber);?></h4>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelado</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">No confirmado Aún</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
...
<hr />
              <?php }}  else { ?>
                <h5 align="center" style="color:red">Aún no hay reserva</h5>
              <?php } ?>
