...
?>   
            ...
            <div class="header_widgets">
              ...
              <p class="uppercase_text">Para soporte envíenos un correo electrónico: </p>
              <a href="mailto:<?php echo htmlentities($email);?>"><?php echo htmlentities($email);?></a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Línea de ayuda de servicio Llámenos: </p>
...
echo "Bienvenido al portal de alquiler de coches";
 } ?>
          </div>
        </div>
      </div>
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">Listado de autos</a>
