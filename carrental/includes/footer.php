      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="newsletter-form">
            ...
            <p class="subscribed-text">*Enviamos grandes ofertas y las últimas noticias sobre automóviles a nuestros usuarios suscritos todas las semanas.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2023 Portal de alquiler de coches. Reservados todos los derechos.</p>
        </div>
      </div>
    </div>
  </div>
