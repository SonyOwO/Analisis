...
echo "<script>alert('Algo salió mal. Inténtalo de nuevo');</script>";
 ...
 echo "<script>alert('Coche ya reservado para estos días.');</script>"; 
 echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
}
...
<tr>
<td>Sistema de freno antibloqueo</td>
...
<tr>
<td>Cerraduras eléctricas para puertas</td>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">Q<?php echo htmlentities($result->PricePerDay);?></p>
