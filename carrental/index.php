    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Carro nuevo</a></li>
        </ul>
      </div>
...
<span class="price">Q<?php echo htmlentities($result->PricePerDay);?> /Dia</span> 
</div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>TESTIMONIO<span> Clientes</span></h2>
    </div>
    <div class="row">
