		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="manage-pages.php?type=privacy">Política y Privacidad</option>
                  <option value="manage-pages.php?type=aboutus">Nosotros</option> 
			...
			?>
									...
									<div class="form-group">
												...
												<div class="col-sm-8">
			<textarea class="form-control" rows="5" cols="50" name="pgedetails" id="pgedetails" placeholder="Detalles de la página" required>
										<?php 
$pagetype=$_GET['type'];
