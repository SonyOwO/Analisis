...
<head>
	...
	<title>Portal de alquiler de coches | Inicio de sesión de administrador</title>
...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/login-bg.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold mt-4x" style="color:#fff">Administrador | Iniciar sesión</h1>
			...
			<p style="margin-top: 4%" align="center"><a href="../index.php">Volver a Inicio</a>	</p>
							</div>
