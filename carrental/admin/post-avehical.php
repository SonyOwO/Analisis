...
if($lastInsertId)
{
$msg="Vehículo publicado correctamente";
}
else 
{
...
<label class="col-sm-2 control-label">Capacidad asientos<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="powerdoorlocks"> Cerraduras eléctricas para puertas </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="driverairbag">Airbag conductor</label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="passengerairbag" name="passengerairbag" value="1">
<label for="passengerairbag">Airbag Pasajero </label>
</div></div>
<div class="checkbox checkbox-inline">
